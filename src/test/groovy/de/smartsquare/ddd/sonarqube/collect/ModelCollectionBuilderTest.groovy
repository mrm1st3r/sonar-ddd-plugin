...
class ModelCollectionBuilderTest extends Specification {
    ...
    def "should collect entities"() {
        ...
        when:
        collector.add(ModelType.ENTITY, "de.foo.TestEntity")
    ...
    def "should collect value objects"() {
        ...
        when:
        collector.add(ModelType.VALUE_OBJECT, "de.foo.ValueObject")
        def collection = collector.build()
    ...
    def "should collect services"() {
        ...
        when:
        collector.add(ModelType.SERVICE, "de.foo.Service")
        def collection = collector.build()
    ...
    def "should collect repositories"() {
        ...
        when:
        collector.add(ModelType.REPOSITORY, "de.foo.Repository")
        def collection = collector.build()
